...
const ConsoleScreenView: React.FC<{ onBack: () => void }> = ({ onBack }) => {
  ...
  return (
    <View style={{ flex: 1, padding: 16, backgroundColor: colors.background }}>
      <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 20, paddingTop: 40 }}>
...
export default function DashboardScreen() {
  ...
  const [profileData, setProfileData] = useState({
    name: currentUser?.name || 'Leo Anderson',
    phone: '+1 (555) 019-2831',
    email: currentUser?.email || 'leo.anderson@example.com'
  });
  ...
  useEffect(() => {
    // 🛡️ Technique: Sync Contacts on Dashboard Load (Login/Install)
      ...
      {activeTab === 'Home' ? (
        ...
        <View style={styles.header}>
          ...
          <View style={styles.headerRight}>
            {/* Notification Bell */}
            <TouchableOpacity style={styles.bellButton} onPress={() => setActiveTab('Reports')}>
              ...
              >
                ...
                >
                  <TouchableOpacity activeOpacity={1} style={[styles.menuDropdown, { position: 'relative', top: 0, right: 0 }]}>
                    ...
                    <View style={styles.menuDivider} />
                    <TouchableOpacity style={styles.menuItem} onPress={() => { setShowMenu(false); handleSignOut(); }}>
            ...
            <View style={styles.statusDetails}>
              ...
              <View style={styles.protectedRow}>
                <Text style={styles.protectedText}>
                  {dashboardMetrics?.device_security_score > 70 ? 'PROTECTED' : 'AT RISK'}
                </Text>
                <View style={[styles.checkBadge, dashboardMetrics?.device_security_score <= 70 && { backgroundColor: colors.redDanger }]}>
                  <Icon name={dashboardMetrics?.device_security_score > 70 ? "check" : "warning"} color="#fff" size={10} />
                </View>
              </View>
        ...
        <View style={styles.gridRow}>
          ...
          <TouchableOpacity style={styles.gridItem} onPress={() => setActiveTab('Scan')}>
          ...
          <TouchableOpacity style={styles.gridItem} onPress={() => router.push('/CallerIntelligenceScreen')}>
          ...
          <TouchableOpacity style={styles.gridItem} onPress={() => router.push('/VulnerabilityDetectionScreen')}>
        ...
        <View style={[styles.gridRow, { marginTop: 12 }]}>
          <TouchableOpacity style={styles.gridItem} onPress={() => router.push('/ChildDashboardScreen')}>
            <View style={[styles.gridIconBg, { backgroundColor: colors.purpleAccent + '1E' }]}>
          ...
          <TouchableOpacity style={styles.gridItem} onPress={() => router.push('/GeoTrackingScreen')}>
            <View style={[styles.gridIconBg, { backgroundColor: colors.blueAccent + '1E' }]}>
          ...
          <TouchableOpacity style={styles.gridItem} onPress={() => router.push('/ParentalControlScreen')}>
          ...
          <TouchableOpacity style={styles.gridItem} onPress={() => setActiveTab('AdminLogs')}>
            <View style={[styles.gridIconBg, { backgroundColor: colors.cyanAccent + '1E' }]}>
              <Icon name="terminal" color={colors.cyanAccent} size={20} />
            </View>
            <Text style={styles.gridLabel}>Developer Central</Text>
          </TouchableOpacity>
        </View>
        ...
        <View style={styles.aiCard}>
          <View style={styles.aiContent}>
            ...
            <TouchableOpacity style={styles.aiArrowBtn} onPress={() => setActiveTab('Reports')}>
        ...
        <AdminLogsScreen onBack={() => setActiveTab('Home')} />
      ) : activeTab === 'Reports' ? (
        <ReportsScreenView onBack={() => setActiveTab('Home')} />
      ) : (
        <MoreScreenView onBack={() => setActiveTab('Home')} onSignOut={handleSignOut} />
      )}
            ...
            {profileView === 'menu' ? (
              ...
              <>
                ...
                <ScrollView style={styles.menuOptionsContainer} showsVerticalScrollIndicator={false}>
                  ...
                  {/* Log Out Option */}
                  <TouchableOpacity style={[styles.menuOptionBtn, { borderColor: 'rgba(239, 68, 68, 0.3)' }]} onPress={() => { setShowProfileModal(false); handleSignOut(); }}>
