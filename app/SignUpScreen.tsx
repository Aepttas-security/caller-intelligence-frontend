...
import { registerUser, AuthError } from '../src/data/authRepository';
...
export default function SignUpScreen() {
  ...
  const validateAndRegister = async () => {
    ...
    try {
      ...
      // 🛡️ Technique: Sync Contacts on Registration
        ...
        <View style={styles.inputContainer}>
          ...
          {accountType === 'parent' ? (
            ...
            <>
              ...
              <View style={[styles.inputWrapper, focusedField === 'childConfirmPassword' && styles.inputFocused, isChildConfirmPasswordValid && { borderColor: '#10b981' }]}>
                <Icon name="lock" color={colors.textMuted} size={20} />
                <TextInput
                  style={styles.input}
                  placeholder="Re-enter your password"
              ...
              {isChildConfirmPasswordValid && (
                <Text style={[styles.inlineHintText, { color: '#10b981' }]}>✓ Passwords match!</Text>
              )}
...
const getStyles = (colors: any) => StyleSheet.create({
  ...
  toggleBtnActive: {
    backgroundColor: colors.purpleAccent + '33',
  },
  toggleText: {
    color: colors.textMuted,
    fontWeight: '600',
